...
from parasect.core.constants import INCLUDED_SUBSTRATES_FILE_PARAS_ALL_SUBSTRATES
...
KNOWN_SUBSTRATES: list[SubstrateName] = [
    ...
    SubstrateName("2S-4-amino-2-hydroxybutyrate", "AHBA", "X"),
    ...
    SubstrateName("acetyl-CoA", "AcCoA", "X"),
    ...
    SubstrateName("shikimic acid", "Shi", "X"),
...
if __name__ == "__main__":
    substrates = parse_substrate_list(INCLUDED_SUBSTRATES_FILE_PARAS_ALL_SUBSTRATES)

    for substrate in substrates:
        try:
            get_substrate_by_name(substrate)
        except ValueError:
            print(f"Substrate {substrate} not in antiSMASH")