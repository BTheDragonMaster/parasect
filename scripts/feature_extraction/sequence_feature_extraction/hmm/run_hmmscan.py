...
HMM3_FILE = os.path.join(os.path.dirname(parasect.data.sequence_data.hmm.__file__), "AMP-binding_full.hmm")
HMM2_FILE = os.path.join(os.path.dirname(parasect.data.sequence_data.hmm.__file__), "AMP-binding_hmmer2.hmm")
...
def run_hmmpfam2_single(hmm_dir, fasta_sequence, max_eval=0.1):
    ...
    with subprocess.Popen(
        ["hmmpfam2", "-E", str(max_eval), hmm_dir, "-"],
        stdin=stdin,
