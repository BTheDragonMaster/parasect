...
import parasect.data.sequence_data.amino_acid_properties
from parasect.scripts.parsers.parsers import parse_amino_acid_properties
...
PROPERTIES_FILE: str = os.path.join(
    os.path.dirname(parasect.data.sequence_data.amino_acid_properties.__file__),
...
def to_feature_vectors(
    id_to_features: dict[str, Union[list[float], list[int]]]
