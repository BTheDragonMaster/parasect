...
import parasect.data.sequence_data.residue_positions

APOSITION_FILE = os.path.join(
    os.path.dirname(parasect.data.sequence_data.residue_positions.__file__),
    "stachelhaus.txt",
)
APOSITION_FILE_34 = os.path.join(
    os.path.dirname(parasect.data.sequence_data.residue_positions.__file__),
    "active_site.txt",
)
APOSITION_FILE_HMM3 = os.path.join(
    os.path.dirname(parasect.data.sequence_data.residue_positions.__file__),
    "stachelhaus_hmm3.txt",
)
APOSITION_FILE_34_HMM3 = os.path.join(
    os.path.dirname(parasect.data.sequence_data.residue_positions.__file__),
    "active_site_hmm3.txt",
)
APOSITION_FILE_HMM2 = os.path.join(
    os.path.dirname(parasect.data.sequence_data.residue_positions.__file__),
    "stachelhaus_hmm2.txt",
)
APOSITION_FILE_34_HMM2 = os.path.join(
    os.path.dirname(parasect.data.sequence_data.residue_positions.__file__),
    "active_site_hmm2.txt",
)
