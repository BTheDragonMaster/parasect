...
from parasect.scripts.parsers.fasta import read_fasta, write_fasta
...
from parasect.scripts.feature_extraction.sequence_feature_extraction.profile_alignment.align import (
    align_adomain,
    ALIGNMENT_FILE,
    REF_SEQUENCE,
)
