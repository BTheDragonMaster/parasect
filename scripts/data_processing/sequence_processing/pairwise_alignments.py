...
from parasect.scripts.parsers.parsers import parse_domain_list
    ...
    with open(out_file, "w") as out:
        ...
        for i, domain_1 in enumerate(test_domains):
            ...
            for domain_2 in train_domains:
                ...
                identity = get_pairwise_identity(
                    domain_to_seq[domain_1].upper(),
                    domain_to_seq[domain_2].upper(),
                    aligner,
                )
