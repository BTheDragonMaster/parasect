import argparse
import os
from parasect.scripts.parsers.parsers import parse_interactions, parse_domain_list
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to folder containing files storing interaction per substrate.",
    )
