...
from parasect.scripts.parsers.parsers import parse_specificities, parse_domain_list
from parasect.scripts.data_analysis.count_substrates import (
    count_substrates_from_file,
    count_substrates,
)
from parasect.scripts.data_processing.relabel_data import relabel_from_inclusion_limit
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=int,
        default=11,
        help="Minimum number of samples required to be considered for training",
    )
