...
from parasect.scripts.data_processing.structure_processing.add_dummy_substrate import (
    add_dummy_substrate,
)
from parasect.scripts.parsers.parsers import parse_sequence_feature_importances
from parasect.scripts.parsers.pdb import sequence_from_pdb
from parasect.scripts.machine_learning.feature_inference.plot_importances_pymol import (
    importance_to_colour,
)
...
from parasect.scripts.feature_extraction.sequence_feature_extraction.sequence_labels import (
    parse_domain_id,
)
...
def parse_arguments():
    ...
    parser.add_argument(
        "-header",
        action="store_true",
        help="If feature importance files contains header, give this argument",
    )
...
def run():
    ...
    for feature_type, residue_to_importance in feature_type_to_importances.items():
        ...
        visualise_in_pymol(
            pdb_in,
            signature_residue_nrs,
            residue_to_importance,
            residue_importance_file,
        )
