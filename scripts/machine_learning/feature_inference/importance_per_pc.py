...
def visualise_in_pymol(pdb_in, voxels, pse_out):
    ...
    for i, category in enumerate(categories):
        ...
        for j, letter_pair in enumerate(letter_pairs):
            ...
            if (
                not letter_pair.startswith("A")
                and not letter_pair.startswith("B")
                and not letter_pair.startswith("C")
                and not letter_pair.startswith("D")
                and not letter_pair.startswith("E")
            ):
