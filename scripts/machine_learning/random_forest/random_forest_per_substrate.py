...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to input directory containing training and test data.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to directory containing interaction files per substrate",
    )
...
class RandomForestParasectSingle:
    ...
    def test_model(self, test_domain_file, classifier_file, domain_to_moment_vector):
        ...
        if probs_tp:
            print(
                f"True positive: {TP} (average probability of interaction: {mean(probs_tp)}; median: {median(probs_tp)})"
            )
        else:
        ...
        if probs_tn:
            print(
                f"True negative: {TN} (average probability of interaction: {mean(probs_tn)}; median: {median(probs_tn)})"
            )
        else:
