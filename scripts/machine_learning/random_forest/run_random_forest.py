...
from parasect.scripts.machine_learning.random_forest.random_forest import (
    RandomForest,
    Dataset,
)
from parasect.scripts.parsers.parsers import (
    parse_specificities,
    parse_morgan_fingerprint,
    parse_pca_file,
    parse_pocket_features,
    parse_domain_list,
    parse_substrate_list,
    parse_proteinbert_features,
)
...
from parasect.scripts.feature_extraction.sequence_feature_extraction.seq_to_features import (
    get_sequence_features_bulk,
)
from parasect.scripts.parsers.iterate_over_dir import find_crossval_pairs
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to output directory (crossval and test mode) or \
    file (train mode)",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="crossval",
        help="Must be 'test', 'train', or 'crossval'",
    )
    parser.add_argument("-type", type=str, required=True, help="'tandem' or 'single_label'.")

    parser.add_argument(
        "-substrates",
        type=str,
        default=None,
        help="Path to file containing considered substrates.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to file containing active site signatures",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to file containing ProteinBert features.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Nr of threads. -1 uses all available cores",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to classifier. Only used in 'test' mode.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="balanced, balanced_subsample, over_sample, under_sample or None",
    )
    parser.add_argument(
        "-one_hot",
        action="store_true",
        help="Use one-hot encoding instead of physicochemical properties for featurisation.",
    )
...
def run():
    ...
    if args.mode == "train":
        ...
        rf = RandomForest(sampling_method=args.sampling, nr_trees=args.trees, threads=args.threads)
        ...
        dataset = Dataset(
            ...
            domain_mappings,
            domain_mapping_to_categories,
            compound_mappings,
            compound_mapping_to_categories,
            mode=args.type,
        )
