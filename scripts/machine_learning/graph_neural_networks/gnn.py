...
class MPNN(torch.nn.Module):
    ...
    def forward(self, data: Data) -> torch.Tensor:
        ...
        for _ in range(self.message_passing_steps):
            ...
            )  # Output with edges; collects important edges (for output) (salt)
...
def train_loop(model: nn.Module, loader: DataLoader, optimizer: Optimizer, criterion: ty.Callable) -> float:
    """
