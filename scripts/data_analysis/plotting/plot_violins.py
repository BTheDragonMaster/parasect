...
import parasect.data.benchmarking.result_summaries

from parasect.scripts.parsers.parsers import parse_domain_list, parse_closest_identities
...
SUMMARY_FILE_CLASS = os.path.join(os.path.dirname(parasect.data.benchmarking.result_summaries.__file__), "class.txt")
SUMMARY_FILE_PHYLOGENY = os.path.join(
    os.path.dirname(parasect.data.benchmarking.result_summaries.__file__),
    "phylogeny.txt",
)
...
CLASS_IDENTITIES = os.path.join(
    os.path.dirname(parasect.data.train_test_splits.__file__),
    "class/domain_to_identity.txt",
)
PHYLOGENY_IDENTITIES = os.path.join(
    os.path.dirname(parasect.data.train_test_splits.__file__),
    "phylogeny/domain_to_identity.txt",
)
...
if __name__ == "__main__":
    ...
    plot_violins(
        PHYLOGENY_IDENTITIES,
        SUMMARY_FILE_PHYLOGENY,
        DOMAINS_PHYLOGENY_SANDPUMA,
        phylogeny_out,
    )
