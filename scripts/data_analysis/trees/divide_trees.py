...
from parasect.scripts.parsers.parsers import parse_specificities, parse_substrate_list
from parasect.scripts.data_processing.divide_into_substrate_groups import (
    SUBSTRATE_GROUPS,
)
