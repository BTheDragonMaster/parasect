...
from parasect.scripts.data_analysis.pca.pca import Pca
from parasect.scripts.parsers.parsers import parse_domain_list, parse_specificities
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Fasta file containing sequences to be contextualised.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to domain list of domains that provide context",
    )
