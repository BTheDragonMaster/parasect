...
from parasect.scripts.data_analysis.pca.pca import PcaData
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Minimal number of occurrences of a substrate for visualising",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="min",
        help="Specifies if number of occurrences is upper or lower bound",
    )
...
def run():
    ...
    pca_data.visualise(
        ...
        z=args.z,
        substrates=args.sv,
        domains_of_interest=args.d,
        domain_labels=args.l,
    )
