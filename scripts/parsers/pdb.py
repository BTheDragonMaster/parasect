...
from parasect.scripts.math.shapes import Vector3D, Sphere
from parasect.data.sequence_data.amino_acid_properties.amino_acid_dictionaries import (
    AA_TABLE,
)
from parasect.scripts.parsers.atom import Atom, Residue
