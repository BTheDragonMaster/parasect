...
from parasect.scripts.math.shapes import Cube, Vector3D
from parasect.scripts.parsers.atom import Atom
...
ATOM_TO_RESIDUE_TO_TYPE = {
    "CG": {"Y": ["aromatic"], "F": ["aromatic"], "W": ["aromatic"], "H": ["aromatic"]},
    "CD1": {"Y": ["aromatic"], "F": ["aromatic"], "W": ["aromatic"]},
    "CD2": {"Y": ["aromatic"], "F": ["aromatic"], "W": ["aromatic"], "H": ["aromatic"]},
    "CE1": {"Y": ["aromatic"], "F": ["aromatic"], "W": ["aromatic"], "H": ["aromatic"]},
    "CE2": {"Y": ["aromatic"], "F": ["aromatic"], "W": ["aromatic"]},
    "CE3": {"W": ["aromatic"]},
    "CZ": {"Y": ["aromatic"], "F": ["aromatic"], "W": ["aromatic"]},
    "CZ2": {"W": ["aromatic"]},
    "CZ3": {"W": ["aromatic"]},
    "CH2": {"W": ["aromatic"]},
    "ND1": {"W": ["aromatic"], "H": ["aromatic", "+"]},
    "ND2": {"N": ["pos_polar"]},
    "NE1": {"W": ["aromatic", "pos_polar"]},
    "NE2": {"Q": ["pos_polar"], "H": ["aromatic", "+"]},
    "OD1": {"D": ["-"], "N": ["neg_polar"]},
    "OD2": {"D": ["-"]},
    "OE1": {"E": ["-"], "Q": ["neg_polar"]},
    "OE2": {"E": ["-"]},
