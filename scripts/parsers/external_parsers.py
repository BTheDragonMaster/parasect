...
import parasect.data.benchmarking.benchmarking_set
from parasect.scripts.parsers.tabular import Tabular
from pprint import pprint


SANDPUMA_IDENTITY = os.path.join(os.path.dirname(parasect.data.benchmarking.benchmarking_set.__file__), "pid.res.tsv")
SANDPUMA_INDIVIDUAL_PREDICTIONS = os.path.join(
    os.path.dirname(parasect.data.benchmarking.benchmarking_set.__file__), "ind.res.tsv"
)
SANDPUMA_PREDICTIONS = os.path.join(
    os.path.dirname(parasect.data.benchmarking.benchmarking_set.__file__),
    "sandpuma.tsv",
)
FORCED_PREDICTIONS = os.path.join(os.path.dirname(parasect.data.benchmarking.benchmarking_set.__file__), "ens.res.tsv")

SANDPUMA_ABBREVIATIONS = os.path.join(
    os.path.dirname(parasect.data.benchmarking.__file__), "sandpuma_abbreviations.txt"
)
