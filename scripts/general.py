...
import parasect.data.compound_data

from parasect.scripts.parsers.fasta import yield_fasta
from parasect.scripts.parsers.gbk_to_fasta import proteins_from_genbank
...
from parasect.scripts.feature_extraction.sequence_feature_extraction.rename_sequences import (
    rename_sequences,
    reverse_renaming,
)
...
from parasect.scripts.feature_extraction.sequence_feature_extraction.adenylation_domain import (
    VALID_CHARACTERS,
)

INCLUDED_SUBSTRATES = os.path.join(os.path.dirname(parasect.data.compound_data.__file__), "included_substrates.txt")
FINGERPRINTS = os.path.join(os.path.dirname(parasect.data.compound_data.__file__), "fingerprints.txt")
